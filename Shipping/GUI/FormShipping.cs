...
namespace Shipping
{
    public partial class FormList : Form
    {
        ...
        private void btnPrintInvoice_Click(object sender, EventArgs e)
        {
            ...
            ppd.Document.DocumentName = "LOADING PRINT PREVIEW";
            document.PrintPage += document_PrintInvoice;
            ppd.ShowDialog();
        }

        void document_PrintInvoice(object sender, PrintPageEventArgs e)
        {
            ...
            Font font = new Font("Arial Narrow", 12f);
            StringFormat fmt = FmtRight;
            e.Graphics.PageUnit = GraphicsUnit.Millimeter;
            for (int i = 0; i < lstBxPackages.Items.Count; i++)
            {
                e.Graphics.DrawString(lstBxPackages.Items[i].ToString(), font, Brushes.Black, leftMargin, topMargin + h * i, fmt);
            }
        }

        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
        Font printFont = this.lstBxPackages.Font;
        ...
        private void btnPrintShippingLabel_Click(object sender, EventArgs e)
        {
            ...
            ppd.Document = document;
            ppd.Document.DocumentName = "LOADING PRINT PREVIEW";
            document.PrintPage += document_PrintShippingLabel;
            ppd.ShowDialog();
        }

        void document_PrintShippingLabel(object sender, PrintPageEventArgs e)
        {
            StringFormat FmtRight = new StringFormat() { Alignment = StringAlignment.Near };
            int leading = 5;
            int leftMargin = 25;
            ...
            StringFormat fmt = FmtRight;
            e.Graphics.PageUnit = GraphicsUnit.Millimeter;
            string labelstring = "From: " + txtBxSName.Text + "\n" + txtBxSAddress.Text + " " + txtBxSCity.Text + " " + txtBxSState.Text + " " + txtBxSZip.Text + "\n" + "To: " + txtBxRName.Text + " " + txtBxRAddress.Text + " " + txtBxRCity.Text + " " + txtBxRState.Text + " " + txtBxRZip.Text + "\n" + "Package Weight: " + txtBxWeight.Text + "oz.";
           
            e.Graphics.DrawString(labelstring, font, Brushes.Black, leftMargin, topMargin + h, fmt);
